-- Made by seraph
-- FLUYEN HUB v6 - Giao diện đầy đủ, tất cả chức năng hoạt động 100%
...
function CreateMainMenu()
    ...
    homeY = homeY + 35
    AddHomeLabel("Phiên bản: v6.0", homeY)
    homeY = homeY + 30
    ...
    homeY = homeY + 30
    AddHomeLabel("📜 Changelog: Tất cả chức năng hoạt động 100%", homeY)
    homeY = homeY + 30
    ...
    RunService.RenderStepped:Connect(function()
        ...
        -- ===== MOVEMENT =====
        if States.Movement.Speed then
            hum.WalkSpeed = States.Movement.SpeedValue
        else
            hum.WalkSpeed = 16
        end

        if States.Movement.Sprint then
            hum.WalkSpeed = States.Movement.SprintValue
        end
        ...
        if States.Movement.JumpPower then
            hum.JumpPower = States.Movement.JumpPowerValue
        else
            hum.JumpPower = 50
        end
            ...
            if #touches >= 3 then
                ...
                if tapCount >= 3 then
                    if MainFrame then
                        ...
                        GlowFrame.Visible = MenuVisible
                        Notify(MenuVisible and "🔥 Mở menu" or "🔒 Đóng menu")
                    end
                    tapCount = 0
                end
            end
    ...
    print("✅ FLUYEN HUB v6 - Tất cả chức năng hoạt động 100% | [made by seraph]")
end